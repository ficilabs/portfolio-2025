...
function createTitleObserver(target: Element, timeline: gsap.core.Timeline): IntersectionObserver {
...
function createCursorTimeline(cursorRef: Element) {
  ...
  tl.fromTo(
    cursorRef,
    { autoAlpha: 1 },
    { autoAlpha: 0, duration: 0.5, ease: 'steps(1)' }
  )
  return tl
}
  ...
  <section class="project">
    <div class="project__group">
      <h2 class="project__title">
        ...
        <span ref="cursorRef" class="dot">_</span>
      </h2>
